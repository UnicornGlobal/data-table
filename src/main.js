...
DataTable.install = function(Vue, options) {
  ...
  Vue.prototype.$assets = {
    ...
    clear: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path stroke="grey" stroke-width="3.4" d="m2.4,2.4 15.2,15.2m0-15.2-15.2,15.2"/></svg>')`
  }
